...
```{r setup-tibble}
team_data <- tibble(
  name = c("Kate", "Ellie", "Connor", 
           "Kate", "Torgun"),
  github_username = c("KateF26", "EllieSmith1406", "CBurett-123", 
                      "KateH-Robinson", "torgun"), 
  colour = c("pink", "blue", "orange", 
             "green", "green"),
  hobby = c("Badminton", "Basketball", "Guitar", 
            "Singing", "Minecraft"),
  favourite_number = c(6, 6, 6, 4, 8)
  )
